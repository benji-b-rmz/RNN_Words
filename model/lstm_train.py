...
# current corpus are quotes from hitchhikers guide to the galaxy on goodreads
# found https://www.goodreads.com/work/quotes/3078186-the-hitch-hiker-s-guide-to-the-galaxy
...
# Loss and optimizer, Note that logits are expected to be unscaled
...
with tf.Session() as session:
    ...
    save_path = saver.save(session, './checkpoints/hh_model.ckpt')
